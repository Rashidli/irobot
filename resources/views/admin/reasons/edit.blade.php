    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{route('reasons.update', $reason->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{$reason->translate('en')->title}}</h4>
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    <label class="col-form-label">Başlıq az</label>
                                    <input class="form-control" type="text" name="az_title" value="{{$reason->translate('az')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="en_title" value="{{$reason->translate('en')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="ru_title" value="{{$reason->translate('ru')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="is_active" id="" class="form-control">
                                        ...
                                        <option value="0" {{!$reason->is_active  ? 'selected' : ''}}>Deactive</option>
                                    </select>
                                </div>
