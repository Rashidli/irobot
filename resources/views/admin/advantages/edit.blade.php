    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form action="{{route('advantages.update', $advantage->id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{$advantage->translate('en')->title}}</h4>
                        <div class="row">
                            <div class="col-6">

                                <div class="mb-3">
                                    <label class="col-form-label">Başlıq az</label>
                                    <input class="form-control" type="text" name="az_title" value="{{$advantage->translate('az')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="en_title" value="{{$advantage->translate('en')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="ru_title" value="{{$advantage->translate('ru')->title}}">
                                    @if($errors->first('ru_title')) <small class="form-text text-danger">{{$errors->first('ru_title')}}</small> @endif
                                </div>

                                <div class="mb-3">
                                    <img style="width: 100px; height: 100px; background-color: black" src="{{asset('storage/' . $advantage->image)}}" class="uploaded_image" alt="{{$advantage->image}}">
