                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    <label class="col-form-label">Adı az</label>
                                    <input class="form-control" type="text" name="az_title" value="{{$shop->translate('az')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" type="text" name="az_address">{{$shop->translate('az')->address}}</textarea>
                                    @if($errors->first('az_address')) <small class="form-text text-danger">{{$errors->first('az_address')}}</small> @endif
                                </div>
