...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <form action="{{ route('products.product_features.store', $product) }}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-body">
...
{{--                                    <textarea class="form-control" name="az_description"></textarea>--}}
...
{{--                                    <textarea class="form-control" name="ru_description"></textarea>--}}
