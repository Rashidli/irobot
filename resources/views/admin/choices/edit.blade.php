...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            ...
            @endif
            <form action="{{route('choices.update', $choice->id)}}" method="post" enctype="multipart/form-data">
                {{ method_field('PUT') }}
                @csrf
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{$choice->translate('en')->title}}</h4>
                        <div class="row">
                            <div class="col-6">

                                <div class="mb-3">
                                    <label class="col-form-label">Başlıq az</label>
                                    <input class="form-control" type="text" name="az_title" value="{{$choice->translate('az')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="en_title" value="{{$choice->translate('en')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="ru_title" value="{{$choice->translate('ru')->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea  class="form-control" type="text" name="az_description">{{$choice->translate('az')->description}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" type="text" name="en_description">{{$choice->translate('en')->description}}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" type="text" name="ru_description">{{$choice->translate('ru')->description}}</textarea>
                                    @if($errors->first('ru_description')) <small class="form-text text-danger">{{$errors->first('ru_description')}}</small> @endif
                                </div>

                                <div class="mb-3">
                                    <img style="width: 100px; height: 100px;" src="{{asset('storage/' . $choice->image)}}" class="uploaded_image" alt="{{$choice->image}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="is_active" id="" class="form-control">
                                        <option value="1" {{$choice->is_active  ? 'selected' : ''}}>Active</option>
                                        <option value="0" {{!$choice->is_active  ? 'selected' : ''}}>Deactive</option>
                                    </select>
                                </div>
