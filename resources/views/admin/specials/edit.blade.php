                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="az_title" value="{{$special->translate('az')?->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="en_title" value="{{$special->translate('en')?->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="ru_title" value="{{$special->translate('ru')?->title}}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" type="text" name="az_description">{{$special->translate('az')->description}}</textarea>
                                ...
                                <div class="mb-3">
                                    <img style="width: 100px; height: 100px;" src="{{asset('storage/' . $special->image)}}" class="uploaded_image" alt="{{$special->image}}">
                                ...
                                <div class="mb-3">
                                    <img style="width: 100px; height: 100px;" src="{{asset('storage/' . $special->image1)}}" class="uploaded_image" alt="{{$special->image1}}">
                                    <div class="form-group">
                                        <label >Şəkil 1</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="products[]" class="form-control js-example-basic-single" multiple>
                                        ...
                                        @foreach($products as $product)
                                            <option value="{{$product->id}}" {{$special->products->contains($product->id) ? 'selected' : ''}}>
                                                {{$product->title}}
                                            </option>
                                        @endforeach
                                    </select>
