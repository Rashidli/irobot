                        ...
                        <div class="row mt-4">
                            <div class="col-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="checkbox" name="is_new" value="{{old('is_new')}}">
                                ...
                                <div class="mb-3">
                                    <label class="col-form-label">Çox satılan məhsul?</label>
                                    <input type="checkbox" name="is_paket" value="{{old('is_paket')}}">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="mess_coming" class="form-control">
                                            <option value="parent">Valideynlər</option>
